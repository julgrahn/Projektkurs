...
void initGameHUD2(SDL_Renderer *renderer, SDL_Rect textRect[], SDL_Texture **textTexture, SDL_Rect aScorerect[], SDL_Texture** scoreTexture, SDL_Rect aRoundStateRect[], SDL_Texture* roundStateTexture[]);
